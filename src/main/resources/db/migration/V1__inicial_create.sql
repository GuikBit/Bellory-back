...
CREATE TABLE app.instance_knowledgebase
(
    id          BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    ...
    CONSTRAINT pk_instance_knowledgebase PRIMARY KEY (id)
);
...
ALTER TABLE app.instance
    ADD CONSTRAINT uc_instance_settings UNIQUE (settings_id);
...
ALTER TABLE app.instance_knowledgebase
    ADD CONSTRAINT FK_INSTANCE_KNOWLEDGEBASE_ON_INSTANCE FOREIGN KEY (instance_id) REFERENCES app.instance (id);

ALTER TABLE app.instance
    ADD CONSTRAINT FK_INSTANCE_ON_ORGANIZACAO FOREIGN KEY (organizacao_id) REFERENCES app.organizacao (id);

ALTER TABLE app.instance
    ADD CONSTRAINT FK_INSTANCE_ON_SETTINGS FOREIGN KEY (settings_id) REFERENCES app.instance_settings (id);
