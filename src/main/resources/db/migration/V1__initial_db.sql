...
(
    ...
    acesso_adm_login                   VARCHAR(255),
    acesso_adm_senha                   VARCHAR(255),
    acesso_adm_role                    VARCHAR(255),
...
CREATE UNIQUE INDEX idx_page_tenant_slug ON page (tenant_id, slug);

CREATE UNIQUE INDEX idx_tenant_subdomain ON tenant (subdomain);

ALTER TABLE agendamento
    ADD CONSTRAINT FK_AGENDAMENTO_ON_CLIENTE FOREIGN KEY (cliente_id) REFERENCES cliente (id);

ALTER TABLE agendamento
    ADD CONSTRAINT FK_AGENDAMENTO_ON_ORGANIZACAO FOREIGN KEY (organizacao_id) REFERENCES organizacao (id);

ALTER TABLE bloqueio_agenda
    ADD CONSTRAINT FK_BLOQUEIO_AGENDA_ON_AGENDAMENTO FOREIGN KEY (agendamento_id) REFERENCES agendamento (id);

ALTER TABLE bloqueio_agenda
    ADD CONSTRAINT FK_BLOQUEIO_AGENDA_ON_FUNCIONARIO FOREIGN KEY (funcionario_id) REFERENCES funcionario (id);

ALTER TABLE cargo_funcionario
    ADD CONSTRAINT FK_CARGO_FUNCIONARIO_ON_ORGANIZACAO FOREIGN KEY (organizacao_id) REFERENCES organizacao (id);

ALTER TABLE cartao_credito
    ADD CONSTRAINT FK_CARTAO_CREDITO_ON_CLIENTE FOREIGN KEY (cliente_id) REFERENCES cliente (id);

ALTER TABLE categoria
    ADD CONSTRAINT FK_CATEGORIA_ON_ORGANIZACAO FOREIGN KEY (organizacao_id) REFERENCES organizacao (id);

ALTER TABLE cliente
    ADD CONSTRAINT FK_CLIENTE_ON_ORGANIZACAO FOREIGN KEY (organizacao_id) REFERENCES organizacao (id);

ALTER TABLE cobranca
    ADD CONSTRAINT FK_COBRANCA_ON_AGENDAMENTO FOREIGN KEY (agendamento_id) REFERENCES agendamento (id);

ALTER TABLE cobranca
    ADD CONSTRAINT FK_COBRANCA_ON_CLIENTE FOREIGN KEY (cliente_id) REFERENCES cliente (id);

ALTER TABLE cobranca
    ADD CONSTRAINT FK_COBRANCA_ON_COMPRA FOREIGN KEY (compra_id) REFERENCES compra (id);

ALTER TABLE cobranca
    ADD CONSTRAINT FK_COBRANCA_ON_ORGANIZACAO FOREIGN KEY (organizacao_id) REFERENCES organizacao (id);

ALTER TABLE compra
    ADD CONSTRAINT FK_COMPRA_ON_CLIENTE FOREIGN KEY (cliente_id) REFERENCES cliente (id);

ALTER TABLE compra
    ADD CONSTRAINT FK_COMPRA_ON_ORGANIZACAO FOREIGN KEY (organizacao_id) REFERENCES organizacao (id);

ALTER TABLE compra_produto
    ADD CONSTRAINT FK_COMPRA_PRODUTO_ON_COMPRA FOREIGN KEY (compra_id) REFERENCES compra (id);

ALTER TABLE compra_produto
    ADD CONSTRAINT FK_COMPRA_PRODUTO_ON_PRODUTO FOREIGN KEY (produto_id) REFERENCES produto (id);

ALTER TABLE config_sistema
    ADD CONSTRAINT FK_CONFIG_SISTEMA_ON_ORGANIZACAO FOREIGN KEY (organizacao_id) REFERENCES organizacao (id);

ALTER TABLE dados_faturamento_organizacao
    ADD CONSTRAINT FK_DADOS_FATURAMENTO_ORGANIZACAO_ON_ORGANIZACAO FOREIGN KEY (organizacao_id) REFERENCES organizacao (id);

ALTER TABLE endereco
    ADD CONSTRAINT FK_ENDERECO_ON_CLIENTE FOREIGN KEY (cliente_id) REFERENCES cliente (id);

ALTER TABLE funcionario
    ADD CONSTRAINT FK_FUNCIONARIO_ON_ORGANIZACAO FOREIGN KEY (organizacao_id) REFERENCES organizacao (id);

ALTER TABLE horario_trabalho
    ADD CONSTRAINT FK_HORARIO_TRABALHO_ON_JORNADA_DIA FOREIGN KEY (jornada_dia_id) REFERENCES jornada_dia (id);

ALTER TABLE jornada_dia
    ADD CONSTRAINT FK_JORNADA_DIA_ON_FUNCIONARIO FOREIGN KEY (funcionario_id) REFERENCES funcionario (id);

ALTER TABLE jornada_trabalho
    ADD CONSTRAINT FK_JORNADA_TRABALHO_ON_FUNCIONARIO FOREIGN KEY (funcionario_id) REFERENCES funcionario (id);

ALTER TABLE organizacao
    ADD CONSTRAINT FK_ORGANIZACAO_ON_CONFIG_SISTEMA FOREIGN KEY (config_sistema_id) REFERENCES config_sistema (id);

ALTER TABLE organizacao
    ADD CONSTRAINT FK_ORGANIZACAO_ON_ENDERECO_PRINCIPAL FOREIGN KEY (endereco_principal_id) REFERENCES endereco (id);

ALTER TABLE organizacao
    ADD CONSTRAINT FK_ORGANIZACAO_ON_LIMITES_PERSONALIZADOS FOREIGN KEY (limites_personalizados_id) REFERENCES plano_limites (id);

ALTER TABLE organizacao
    ADD CONSTRAINT FK_ORGANIZACAO_ON_PLANO FOREIGN KEY (plano_id) REFERENCES plano (id);

ALTER TABLE pagamento
    ADD CONSTRAINT FK_PAGAMENTO_ON_CARTAO_CREDITO FOREIGN KEY (cartao_credito_id) REFERENCES cartao_credito (id);

ALTER TABLE pagamento
    ADD CONSTRAINT FK_PAGAMENTO_ON_CLIENTE FOREIGN KEY (cliente_id) REFERENCES cliente (id);

ALTER TABLE pagamento
    ADD CONSTRAINT FK_PAGAMENTO_ON_COBRANCA FOREIGN KEY (cobranca_id) REFERENCES cobranca (id);

ALTER TABLE page_component
    ADD CONSTRAINT FK_PAGE_COMPONENT_ON_PAGE FOREIGN KEY (page_id) REFERENCES page (id);

ALTER TABLE page
    ADD CONSTRAINT FK_PAGE_ON_TENANT FOREIGN KEY (tenant_id) REFERENCES tenant (id);

ALTER TABLE plano_cliente
    ADD CONSTRAINT FK_PLANO_CLIENTE_ON_CLIENTE FOREIGN KEY (cliente_id) REFERENCES cliente (id);

ALTER TABLE plano_cliente
    ADD CONSTRAINT FK_PLANO_CLIENTE_ON_COBRANCA FOREIGN KEY (cobranca_id) REFERENCES cobranca (id);

ALTER TABLE plano_cliente
    ADD CONSTRAINT FK_PLANO_CLIENTE_ON_PLANO_SERVICO FOREIGN KEY (plano_servico_id) REFERENCES plano_servico (id);

ALTER TABLE plano_limites
    ADD CONSTRAINT FK_PLANO_LIMITES_ON_PLANO FOREIGN KEY (plano_id) REFERENCES plano (id);

ALTER TABLE plano_servico
    ADD CONSTRAINT FK_PLANO_SERVICO_ON_ORGANIZACAO FOREIGN KEY (organizacao_id) REFERENCES organizacao (id);

ALTER TABLE produto
    ADD CONSTRAINT FK_PRODUTO_ON_CATEGORIA FOREIGN KEY (categoria_id) REFERENCES categoria (id);

ALTER TABLE produto
    ADD CONSTRAINT FK_PRODUTO_ON_ORGANIZACAO FOREIGN KEY (organizacao_id) REFERENCES organizacao (id);

ALTER TABLE servico
    ADD CONSTRAINT FK_SERVICO_ON_CATEGORIA FOREIGN KEY (categoria_id) REFERENCES categoria (id);

ALTER TABLE servico
    ADD CONSTRAINT FK_SERVICO_ON_ORGANIZACAO FOREIGN KEY (organizacao_id) REFERENCES organizacao (id);

ALTER TABLE agendamento_funcionario
    ADD CONSTRAINT fk_agefun_on_agendamento FOREIGN KEY (agendamento_id) REFERENCES agendamento (id);

ALTER TABLE agendamento_funcionario
    ADD CONSTRAINT fk_agefun_on_funcionario FOREIGN KEY (funcionario_id) REFERENCES funcionario (id);

ALTER TABLE agendamento_servico
    ADD CONSTRAINT fk_ageser_on_agendamento FOREIGN KEY (agendamento_id) REFERENCES agendamento (id);

ALTER TABLE agendamento_servico
    ADD CONSTRAINT fk_ageser_on_servico FOREIGN KEY (servico_id) REFERENCES servico (id);

ALTER TABLE funcionario_servico
    ADD CONSTRAINT fk_funser_on_funcionario FOREIGN KEY (funcionario_id) REFERENCES funcionario (id);

ALTER TABLE funcionario_servico
    ADD CONSTRAINT fk_funser_on_servico FOREIGN KEY (servico_id) REFERENCES servico (id);

ALTER TABLE produto_como_usar
    ADD CONSTRAINT fk_produto_como_usar_on_produto FOREIGN KEY (produto_id) REFERENCES produto (id);

ALTER TABLE produto_especificacoes
    ADD CONSTRAINT fk_produto_especificacoes_on_produto FOREIGN KEY (produto_id) REFERENCES produto (id);

ALTER TABLE produto_imagens
    ADD CONSTRAINT fk_produto_imagens_on_produto FOREIGN KEY (produto_id) REFERENCES produto (id);

ALTER TABLE produto_ingredientes
    ADD CONSTRAINT fk_produto_ingredientes_on_produto FOREIGN KEY (produto_id) REFERENCES produto (id);

ALTER TABLE produto_relacionados_assoc
    ADD CONSTRAINT fk_prorelass_on_produto FOREIGN KEY (produto_id) REFERENCES produto (id);

ALTER TABLE produto_relacionados_assoc
    ADD CONSTRAINT fk_prorelass_on_relacionado FOREIGN KEY (relacionado_id) REFERENCES produto (id);

ALTER TABLE produto_utilizados_assoc
    ADD CONSTRAINT fk_proutiass_on_produto FOREIGN KEY (produto_id) REFERENCES produto (id);

ALTER TABLE produto_utilizados_assoc
    ADD CONSTRAINT fk_proutiass_on_utilizado FOREIGN KEY (utilizado_id) REFERENCES produto (id);

ALTER TABLE servico_imagens
    ADD CONSTRAINT fk_servico_imagens_on_servico FOREIGN KEY (servico_id) REFERENCES servico (id);

ALTER TABLE servico_produtos
    ADD CONSTRAINT fk_servico_produtos_on_servico FOREIGN KEY (servico_id) REFERENCES servico (id);
