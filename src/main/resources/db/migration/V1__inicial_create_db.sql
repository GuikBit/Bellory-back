...
ALTER TABLE app.organizacao
    ADD CONSTRAINT FK_ORGANIZACAO_ON_LIMITES_PERSONALIZADOS FOREIGN KEY (limites_personalizados_id) REFERENCES app.plano_limites (id);

ALTER TABLE app.organizacao
    ADD CONSTRAINT FK_ORGANIZACAO_ON_PLANO FOREIGN KEY (plano_id) REFERENCES app.plano (id);
